...
function loadMain()
    ...
    ContentContainer.BackgroundColor3 = Color3.fromRGB(25,25,25) -- thêm màu nền để thấy
    ...
    local function setTab(tab)
        ...
        -- Cập nhật lại vị trí các control (tính lại y)
    ...
    local function addToggle(parent, name, default, callback)
        ...
        -- Tính vị trí dựa trên số con hiện có
        local y = 8
    ...
    fovFrame.Size = UDim2.new(1,-20,0,42)
    ...
    smoothFrame.Size = UDim2.new(1,-20,0,42)
    ...
    -- Khởi tạo lại vị trí cho tất cả các tab
    setTab("ESP")
